 ...
 * リクエストボディ
 */
export interface UpdateShopFormRequest {
    type: 'UpdateShopFormRequest'
    release: boolean
    publishFrom?: string
    publishTo?: string
    priority: number
 ...
 * バリデーションエラー
 */
export interface UpdateShopFormRequestValidationError {
    type: 'UpdateShopFormRequestValidationError'
    error: {
        release?: string
        publishFrom?: string
        publishTo?: string
...
export const isUpdateShopFormRequest = (v: any) => v.type === 'UpdateShopFormRequest'
export const isUpdateShopFormRequestValidationError = (v: any) => v.type === 'UpdateShopFormRequestValidationError'
